...
const DisplayProfile = () => {
  ...
  return (
    <header className="h-[357px] w-full rounded-bl-[32px] rounded-br-[32px] bg-[#fff] pt-4 md:bg-[#633CFF] md:pt-6">
      <Navbar />
      <section className="absolute inset-x-0 top-[138px] flex w-full flex-col items-center rounded-none bg-[#fff] p-0 py-12 shadow-none md:left-0 md:right-0 md:top-[208px] md:m-auto md:min-h-[569px] md:w-[349px] md:rounded-3xl md:bg-[#fff]">
        {/* e5e7eb */}
        <img
          src={`http://localhost:3000/uploads/${displayProfile.profileImage}`}
        ...
        <h2 className="mb-14 leading-[150%] text-[#737373]">
          {isNameAvialable ? displayProfile.email : "Your Email"}
        </h2>
