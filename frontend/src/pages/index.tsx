...
//   return (
//     <>
//       <main className="left-0 top-0 w-full items-start gap-16 bg-[#fafafa] p-8 sm:absolute sm:left-2/4 sm:top-2/4 sm:flex sm:-translate-x-2/4 sm:-translate-y-2/4 sm:flex-col sm:items-center sm:gap-[51px]">
//         {/* <img
//           src={devLinkLogo}
//           width="0"
//           height="0"
